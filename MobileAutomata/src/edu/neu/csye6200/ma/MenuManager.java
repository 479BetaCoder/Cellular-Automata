...
public class MenuManager implements ActionListener {
	 ...
	 */
	public MenuManager(MAApp application) {
	 ...
	 */
	public MenuManager(MAApp application, String text) {
		this.application = application;
		this.text=text;
		this.id = "menu-" + Integer.toString(counter++);
		init();
	 ...
	 */
	public MenuManager(MAApp application, String text, String id) {
		this.application = application;
		this.text = text;
		this.id = id;
		init();
	...
	class ExitAction extends AbstractAction {
		...
		private MAApp application;

		protected ExitAction(MAApp application) {
			super("ExitAction");
			this.application = application;
		}
	...
	class AboutAction extends AbstractAction {
		...
		protected AboutAction(MAApp application) {
			super("AboutAction");
			this.application = application;
		}
